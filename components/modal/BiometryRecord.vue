...
export default {
  ...
  data () {
    return {
      biometry: [
        { id: 1, date: '24/07/2023', responsible: 'Gustavo Luiz' },
        { id: 2, date: '23/05/2023', responsible: 'Gustavo Luiz' },
        { id: 3, date: '22/04/2023', responsible: 'Gustavo Luiz' },
        { id: 4, date: '21/03/2023', responsible: 'Gustavo Luiz' },
        { id: 5, date: '20/01/2023', responsible: 'Gustavo Luiz' },
      ]
    }
  },
  props: {
